...
#COMMON_GLOBAL_CFLAGS += -DMISSING_GRALOC_BUFFERS -DFORCE_CPU_UPLOAD  
...
TARGET_OTA_ASSERT_DEVICE := HuaweiC8860,hwc8860,Huawei,C8860
...
# KERNEL (target path)
#TARGET_KERNEL_SOURCE := (path to source)
...
WIFI_DRIVER__FW_STA_PATH := "/system/wifi/firmware.bin"
WIFI_DRIVER_FW_AP_PATH := "/system/wifi/firmware_apsta.bin"
WIFI_DRIVER_FW_P2P_PATH := "p2p"
